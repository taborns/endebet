...
if( !function_exists('homey_get_localization')) {
	function homey_get_localization() {
		...
		$localization = array(
			...
			'terms_rules' => esc_html__('Terms & rules', 'homey'),
			...
			'openning_hours_label' => esc_html__('Openning Hours', 'homey'),
			...
			'list_submit_msg' => esc_html__('Congratulations. Your listing has been submiited for approval.', 'homey'),
