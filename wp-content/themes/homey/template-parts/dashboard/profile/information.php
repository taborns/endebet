...
<div class="block">
    ...
    <div class="block-body">
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="em_phone"><?php echo esc_attr($homey_local['phone_label']); ?></label>
                    <input type="text" id="em_phone" class="form-control" value="<?php echo esc_attr($phone);?>" placeholder="<?php echo esc_attr($homey_local['phone_plac']); ?>">
