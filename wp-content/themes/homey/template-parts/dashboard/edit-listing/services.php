                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <textarea placeholder="<?php echo esc_attr(homey_option('ad_service_des_plac')); ?>" name="homey_services[<?php echo intval($count); ?>][service_des]" rows="3" class="form-control">
