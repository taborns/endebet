...
?>
<div id="review-form" class="collapse review-form-block review-form-block-user">
    <div class="block">
                    ...
                    <div class="stars">
                        ...
                        <div class="form-msg-btns">
                            ...
                            <?php if(!empty($review_id)) { ?>
                                ...
                                <button id="add_review" class="btn btn-primary btn-xs-full-width"><?php esc_html_e('Update Review', 'homey'); ?></button>
                            <?php } else { ?>
                                <input type="hidden" name="review_action" id="review_action" value="add_review">
                                <button id="add_review" class="btn btn-primary btn-xs-full-width"><?php esc_html_e('Submit Your Review', 'homey'); ?></button>
                            <?php } ?>
                        </div>
