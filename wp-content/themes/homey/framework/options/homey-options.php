...
/*Redux::setSection( $opt_name, array(
    ...
    'fields'        => array(
        ...
        array(
            ...
            'options'  => array(
                'per_day' => esc_html__('Per Day', 'homey'),
                'per_hourly' => esc_html__('Hourly', 'homey'),
                'both' => esc_html__('Both per day and hourly. Choose while add listing.', 'homey')
            ),
            'default' => 'per_day'
        ),
    )
...
Redux::setSection( $opt_name, array(
    ...
    'fields'        => array(
        ...
        array(
            'id'       => 'site_scroll_top',
            'type'     => 'switch',
            'title'    => esc_html__( 'Scroll To Top', 'homey' ),
            'desc'     => '',
            'subtitle' => esc_html__( 'Enable/Disable the scroll to top button', 'homey' ),
            'default'  => 1,
            'on'       => esc_html__( 'Enabled', 'homey' ),
            'off'      => esc_html__( 'Disabled', 'homey' ),
        ),
...
Redux::setSection( $opt_name, array(
    ...
    'fields'           => array(
        ...
        array(
            ...
            'title'    => esc_html__( 'Google Api key', 'homey' ),
            'subtitle' => '',
            'desc'     => esc_html__( 'Enter the Google Api code for Google login', 'homey' ),
            'default'  => ''
        ),
        array(
            'id'       => 'google_client_id',
 ...
 * ----------------------------------------------*/
Redux::setSection( $opt_name, array(
    'title'  => esc_html__( 'Instance Booking', 'homey' ),
    'id'     => 'instance-booking',
    'desc'   => '',
    'subsection'   => true,
    'fields'        => array(
        array(
            ...
            'subtitle' => esc_html__('Enter instance booking page title.', 'homey'),
            'desc' =>'',
        ...
        array(
            ...
            'subtitle' => esc_html__('Enter instance booking page subtitle.', 'homey'),
            'desc' =>'',
        ...
        array(
            ...
            'options' => array(
                'enabled'  => array(
                    ...
                    //'depart'    => $homey_local['depart_label'],
 ...
 * **********************************************************************/
Redux::setSection( $opt_name, array(
    'title'  => esc_html__( 'Google Map Settings', 'homey' ),
    ...
    'fields' => array(
        ...
        /*array(
            ...
            'type'     => 'switch',
            'title'    => esc_html__( 'Limit to ountry', 'homey' ),
            'desc'     => '',
            'desc' => esc_html__( 'Geo autocomplete limit to a specific country', 'homey' ),
            'default'  => 0,
            'on'       => 'Enabled',
            'off'      => 'Disabled',
        ),
        ...
        /*array(
            'id'       => 'geo_location',
            'type'     => 'switch',
            'title'    => esc_html__( 'Geo Location', 'homey' ),
            'desc'     => '',
            'subtitle' => esc_html__( 'Enable/Disable geo location.', 'homey' ),
            'default'  => 0,
            'on'       => 'Enabled',
            'off'      => 'Disabled',
        ),*/
        ...
        /*array(
            ...
            'type'     => 'text',
            'title'    => esc_html__( 'Header Map Zoom', 'homey' ),
            'desc'     => '',
            'subtitle' => esc_html__( '1 to 20', 'homey' ),
            'default'  => '12',
            'validate' => 'numeric'
        ),
        array(
            'id'       => 'halfmap_zoom_level',
            'type'     => 'text',
            'title'    => esc_html__( 'Half Map Zoom', 'homey' ),
            'desc'     => '',
            'subtitle' => esc_html__( '1 to 20', 'homey' ),
            'default'  => '12',
            'validate' => 'numeric'
...
Redux::setSection( $opt_name, array(
    ...
    'fields'    => array(
        array(
            ...
            'desc'   => esc_html__( '{user_login} as username, {user_password} as user password, {user_email_register} as new user email, {profile_url}', 'homey' )
        ),
...
Redux::setSection( $opt_name, array(
    ...
    'desc'   => esc_html__('Global variables {reservation_detail_url}', 'homey' ),
    'icon'   => '',
    'subsection' => true,
    'fields'    => array(
        array(
        ...
        array(
            ...
            'type'     => 'editor',
            'title'    => esc_html__('Email Content', 'homey'),
            'default'  => 'Horay! You received a new reservation on {site_title} <br>
Confirm Availability <a href="{reservation_detail_url}">Confirm</a><br>
<br>
Thank you for choosing Homey!<br>
Homey Team.',
            'args' => array(
...
The invoice number is: {invoice_no}', 'homey'),
            'args' => array(
                'teeny' => true,
                'wpautop' => false,
                'media_buttons' => false,
