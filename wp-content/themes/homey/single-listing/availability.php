            ...
            <div class="block-body">
                ...
                <div class="block-right">
                    <ul class="detail-list detail-list-2-cols">
                        <?php if($hide_labels['sn_min_stay_is'] != 1) { ?>
                        <li>
                            <i class="fa fa-calendar-o" aria-hidden="true"></i> 
                            <?php echo esc_attr(homey_option('sn_min_stay_is'));?> <strong><?php echo esc_attr($min_book_days); ?> <?php echo esc_attr($min_book_days_label);?></strong>
                        </li>
                        <?php } ?>

                        <?php if($hide_labels['sn_max_stay_is'] != 1) { ?>
                        <li>
                            <i class="fa fa-calendar-o" aria-hidden="true"></i> 
