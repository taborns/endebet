...
if( !function_exists('homey_listing_carousel') ) {
	function homey_listing_carousel($atts, $content = null)
	{
		...
		if($listing_style == 'card') {
			$main_classes = 'property-module-card property-module-card-slider property-module-card-slider-'.esc_attr__($slides_to_show);
			$sub_classes = 'item-card-slider-view item-card-slider-view-'.esc_attr__($slides_to_show);
		} else {
			$main_classes = 'property-module-grid property-module-grid-slider property-module-grid-slider-'.esc_attr__($slides_to_show);
		...
		<div class="module-wrap <?php esc_attr_e($main_classes);?>">
			<div class="listing-wrap item-<?php esc_attr_e($listing_style);?>-view">
				<div class="row">
					<div id="homey-listing-carousel-<?php esc_attr_e($token);?>" data-token="<?php esc_attr_e($token); ?>" class="homey-carousel <?php esc_attr_e($sub_classes);?>">
						<?php
